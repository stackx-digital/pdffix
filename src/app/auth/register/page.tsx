    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
        <div className="text-center max-w-md">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mb-2">Semak emel anda</h2>
          <p className="text-gray-500">
            Kami telah menghantar link pengesahan ke <strong>{email}</strong>. Sila klik link tersebut untuk aktifkan akaun anda.
          </p>
