      ...
      <main className="flex-1">
        ...
        <section className="py-6 border-y border-gray-100 bg-white">
          <div className="max-w-4xl mx-auto px-4 flex flex-wrap justify-center gap-8 text-sm text-gray-500">
            <span>🔒 Tiada upload ke pelayan</span>
            <span>⚡ Proses dalam pelayar</span>
            <span>🆓 Fungsi asas percuma</span>
            <span>🇲🇾 Dibina untuk Malaysia</span>
          </div>
        </section>
        ...
        {!user && (
          <section className="bg-red-600 text-white py-16 px-4 text-center">
            <h2 className="text-2xl font-bold mb-2">Daftar Percuma</h2>
            <p className="text-red-100 mb-6">Dapatkan akses penuh kepada semua alat PDF asas.</p>
